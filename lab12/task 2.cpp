...
cout << setw(16) << setw(20) << "credit to account" << right
<< setw(15) << deposit;
}
...
cout << " FEBRUARY Interest Rate = " << intRate2 << "%" << endl;
cout << " NewSaver1 \n";
cout << " 01Feb06 ";
...
cout << endl;
cout << " MARCH Interest Rate = " << intRate3 << "%" << endl;
cout << " ChkingGuy1 \n";
cout << " 01Mar06 ";
